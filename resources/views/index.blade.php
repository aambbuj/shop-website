...
<html lang="en">
  ...
  <div class="container mt-4">
    <h3 class="text-center" style="color:brownd; center">Add your information </h3>
...
@endif
    ...
    <div class="col-md-3 text-center">
        ...
        <input type="number"  name="phone" placeholder="Enter your phone"  required  class="form-control text-center">
    </div>
    ...
    <div class="col-md-3 text-center" style="display:none;" id="post_office_section">
  ...
  <div class="row">
    <div class="col-md-3 text-center block_section" style="display:none;">
